        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4 py-8">
          <div className="text-center w-full">
            ...
            <h1 className="font-extrabold mb-8">
              ...
              <div className="text-3xl md:text-6xl lg:text-8xl xl:text-9xl font-black block tracking-widest text-white drop-shadow-2xl text-shadow-lg transform hover:scale-105 transition-transform duration-300 filter brightness-110">
                My Dream Property
              </div>
            </h1>
