            ...
            <div className="flex items-center space-x-1">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button 
                    variant="ghost" 
                    className={`font-medium text-base px-4 py-2 rounded-md transition-colors duration-200 ${location.includes('/home-loan') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50'}`}
                  >
                    Home Loan
                    <ChevronDown className="ml-1 h-4 w-4" />
                  </Button>
                ...
                <DropdownMenuContent align="center" className="w-80 p-4">
                  <div className="space-y-4">
                    <h3 className="font-semibold text-lg text-gray-900">Get Home Loan</h3>
                    <p className="text-sm text-gray-600">Quick and easy home loan application. Get pre-approved in minutes.</p>
                    
                    <div className="grid grid-cols-1 gap-3">
                      <DropdownMenuItem asChild>
                        <Link href="/home-loan" className="flex items-center justify-between w-full p-3 bg-blue-50 rounded-lg hover:bg-blue-100">
                          <div className="flex items-center">
                            <Calculator className="mr-3 h-5 w-5 text-blue-600" />
                            <div>
                              <div className="font-medium text-blue-900">Apply for Home Loan</div>
                              <div className="text-xs text-blue-600">Complete application form</div>
                            </div>
                          </div>
                        </Link>
                      </DropdownMenuItem>
                      ...
                      <DropdownMenuItem asChild>
                        <Link href="/property-calculator" className="flex items-center justify-between w-full p-3 bg-green-50 rounded-lg hover:bg-green-100">
                          <div className="flex items-center">
                            <BarChart className="mr-3 h-5 w-5 text-green-600" />
                            <div>
                              <div className="font-medium text-green-900">EMI Calculator</div>
                              <div className="text-xs text-green-600">Calculate monthly payments</div>
                            </div>
                          </div>
                        </Link>
                      </DropdownMenuItem>
                    ...
                    <div className="pt-2 border-t border-gray-200">
                      <div className="text-xs text-gray-500">
                        Interest rates starting from <span className="font-semibold text-green-600">8.5% p.a.</span>
                      </div>
                    </div>
                  </div>
                </DropdownMenuContent>
